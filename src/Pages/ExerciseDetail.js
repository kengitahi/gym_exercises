...
const ExerciseDetail = () => {
    ...
    return (
        <Box>
            ...
            <SimilarExercises similarExercises={similarExercises} equipmentExercises={equipmentExercises} target={exerciseDetail.target} equipment={exerciseDetail.equipment} />
        </Box>
